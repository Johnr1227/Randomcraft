...
p_77615_2_.spawnEntityInWorld(EntityLightningBolt);
	}}
...
public class ItemLightningSTICK extends Item
{
    ...
    public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_, EntityPlayer p_77615_3_, int p_77615_4_)
    {
        ...
        if (flag || p_77615_3_.inventory.hasItem(Items.carrot))
        {
            ...
            EntityCreeper EntityArrow2 = new EntityCreeper (p_77615_2_);
    ...
    public ItemStack onItemRightClick(ItemStack p_77659_1_, World p_77659_2_, EntityPlayer p_77659_3_)
    {
        ...
        if (p_77659_3_.capabilities.isCreativeMode || p_77659_3_.inventory.hasItem(Items.carrot))
        {
