...
public class ItemCheeseSword extends Item {

	private float field_150934_a;
	private final Item.ToolMaterial field_150933_b;
	private static final String __OBFID = "CL_00000072";

	public ItemCheeseSword(Item.ToolMaterial p_i45356_1_) {
	...
	@Override
	public void onUpdate(ItemStack itemStack, World world, Entity entity, int someNumber, boolean isHeld) {
		super.onUpdate(itemStack, world, entity, someNumber, isHeld);
		System.out.println("onUpdate: " + isHeld);
	}
	...
	public Multimap getItemAttributeModifiers() {
		...
		multimap.put(SharedMonsterAttributes.attackDamage.getAttributeUnlocalizedName(), new AttributeModifier(
				field_111210_e, "Weapon modifier", (double) this.field_150934_a, 0));
		return multimap;
	}
}
