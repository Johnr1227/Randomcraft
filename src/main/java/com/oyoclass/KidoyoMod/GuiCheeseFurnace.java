...
public class GuiCheeseFurnace {

	@SideOnly(Side.CLIENT)
	public class GuiFurnace extends GuiContainer
	{
	    private final ResourceLocation CheeseGui = new ResourceLocation("textures/gui/container/furnace.png");
	    ...
	    protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int p_146976_2_, int p_146976_3_)
	    {
	        ...
	        this.mc.getTextureManager().bindTexture(CheeseGui);
