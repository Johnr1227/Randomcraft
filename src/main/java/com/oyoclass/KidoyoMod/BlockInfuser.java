...
public class BlockInfuser extends BlockContainer
{
    ...
    protected BlockInfuser(boolean p_i45407_1_)
    {
        super(Material.rock);
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon("cm:infuser_side");
        this.field_149936_O = p_149651_1_.registerIcon(this.field_149932_b ? "cm:infuser_front_lit" : "cm:infuser_front");
        this.field_149935_N = p_149651_1_.registerIcon("cm:infuser_top");
    }
    ...
    public static void updateFurnaceBlockState(boolean p_149931_0_, World p_149931_1_, int p_149931_2_, int p_149931_3_, int p_149931_4_)
    {
        ...
        if (p_149931_0_)
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, CoolMod.Cheese_ore);
        }
        else
        {
            p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, CoolMod.Infuser);
        }
