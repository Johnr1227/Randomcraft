...
public class EntityCheeseTNT extends Entity {
	/** How long the fuse is */
	public int fuse;
	private EntityLivingBase tntPlacedBy;
	private static final String __OBFID = "CL_00001681";

	public EntityCheeseTNT(World p_i1729_1_) {
		super(p_i1729_1_);
	...
	public EntityCheeseTNT(World p_i1730_1_, double p_i1730_2_, double p_i1730_4_, double p_i1730_6_,
