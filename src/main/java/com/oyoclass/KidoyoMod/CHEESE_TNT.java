...
public class CHEESE_TNT extends Block {
	...
	public CHEESE_TNT(Material ice) {
		super(Material.tnt);
		this.setCreativeTab(CreativeTabs.tabRedstone);
	}

	/** The anvil sound type */
	public static final Block.SoundType soundTypeCheese = new Block.SoundType("anvil", 0.3F, 1.0F) {
	...
	{
		this.setStepSound(soundTypeCheese);
	...
	public void onBlockDestroyedByExplosion(World p_149723_1_, int p_149723_2_, int p_149723_3_, int p_149723_4_,
		...
		if (!p_149723_1_.isRemote) {
			EntityCheeseTNT EntityCheeseTNT = new EntityCheeseTNT(p_149723_1_, (double) ((float) p_149723_2_ + 0.5F),
					(double) ((float) p_149723_3_ + 0.5F), (double) ((float) p_149723_4_ + 0.5F),
					p_149723_5_.getExplosivePlacedBy());
			EntityCheeseTNT.fuse = p_149723_1_.rand.nextInt(EntityCheeseTNT.fuse / 4) + EntityCheeseTNT.fuse / 8;
			p_149723_1_.spawnEntityInWorld(EntityCheeseTNT);
		}
	}
	...
	public void func_150114_a(World p_150114_1_, int p_150114_2_, int p_150114_3_, int p_150114_4_, int p_150114_5_,
		...
		if (!p_150114_1_.isRemote) {
			if ((p_150114_5_ & 1) == 1) {
				EntityCheeseTNT EntityCheeseTNT = new EntityCheeseTNT(p_150114_1_,
	...
	public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_,
		...
		if (p_149727_5_.getCurrentEquippedItem() != null
				&& p_149727_5_.getCurrentEquippedItem().getItem() == CoolMod.FlintCheese) {
