...
public class ItemCheeseBow extends ItemBow
{
    ...
    public void onPlayerStoppedUsing(ItemStack p_77615_1_, World p_77615_2_, EntityPlayer p_77615_3_, int p_77615_4_)
    {
        ...
        if (flag || p_77615_3_.inventory.hasItem(Items.arrow))
        {
            ...
            f = (f * f + f * 10000000000.0F) / 5000.0F;
            ...
            EntityArrow2 EntityArrow2 = new EntityArrow2(p_77615_2_, p_77615_3_, f * 2.0F);
            ...
            {
                EntityArrow2.setFire(100000);
            }

            p_77615_1_.damageItem(1, p_77615_3_);
            p_77615_2_.playSoundAtEntity(p_77615_3_, "cm:PVZ", 1.0F, 1.0F / (itemRand.nextFloat() * 0.4F + 1.2F) + f * 0.5F);
